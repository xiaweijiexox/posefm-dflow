...
import ipdb
from generate_utils import vis_during_eval
import os
...
class CompMDMGeneratedDataset(Dataset):
    def __init__(
        ...
        for _idx, (motion, model_kwargs) in tqdm(
            ...
            out_path = "/home/tsinghuaair/xwj/motionfm-main/visual/reg1e-4_smooth_mask/visualize" + str(_idx) 
            config = OmegaConf.load("/home/tsinghuaair/xwj/motionfm-main/config.yaml") 
            ...
            train_platform.report_video_list(
